    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="app-menu">
            <ul class="header-megamenu nav">
                ...
                @endif
                @if (
                    Route::currentRouteName() == 'post.index' ||
                                        ...
                                        <div class="app-menu">
                                            <div class="search-bx mx-5">
                                                <form method="post" action="{{ route('post.search') }}">
                                                    @csrf
                                                    <div class="input-group">
                                                        <input type="search" style="width:150px" class="form-control"
                                                            placeholder="Haber ara" aria-label="(İd - Başlık) Haber ara " aria-describedby="button-addon2"
                                                            name="search" value="{{ $search ?? '' }}">
                                                        <input type="hidden" name="isArchived" value="{{ $archive }}">
                                                        <div class="input-group-append">
                                                            <button class="btn p-1" type="submit" id="button-addon3">
        ...
        <div class="navbar-custom-menu r-side">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu d-none">
                    <a href="#" class="waves-effect waves-light dropdown-toggle btn-outline no-border btn-info-light"
