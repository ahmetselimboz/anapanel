            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Arşiv Haberler</h4>
                        ...
                        <div class="box-controls pull-right">
                            <div class="btn-group">
                                <!-- <a href="{{ route('post_archive') }}" type="button" class="btn btn-success btn-sm mx-xl-3"><i class="fa fa-archive"></i> Arşiv </a>
                                <a href="{{ route('post.create') }}" type="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Haber Ekle</a> -->
                                <a href="{{ route('post.trashed') }}" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Çöp Kutusu</a>
                                <a href="{{ route('post.index') }}"  type="button" class="btn btn-warning btn-sm"><i class="fa fa-reply"></i> </a>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-header -->
                        ...
                        <div class="table-responsive mx-2">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span class="badge badge-primary">@if($post->category_id !=null) {{ $post['category']->title }} @else KATEGORİSİZ @endif</span></td>
