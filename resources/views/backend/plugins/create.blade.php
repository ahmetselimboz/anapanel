    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Yeni Eklenti Ekle</h4>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-body">
                        <form method="POST" action="{{ route('plugin.store') }}" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="license" id="license" class="form-control @error('license') is-invalid @enderror">
                                                    ...
                                                    <option value="MIT" {{ old('license') == 'MIT' ? 'selected' : '' }}>MIT</option>
                                                    <option value="GPL v2" {{ old('license') == 'GPL v2' ? 'selected' : '' }}>GPL v2</option>
                                                    <option value="GPL v3" {{ old('license') == 'GPL v3' ? 'selected' : '' }}>GPL v3</option>
                                                    <option value="Apache 2.0" {{ old('license') == 'Apache 2.0' ? 'selected' : '' }}>Apache 2.0</option>
                                                    <option value="BSD" {{ old('license') == 'BSD' ? 'selected' : '' }}>BSD</option>
                                                    <option value="Proprietary" {{ old('license') == 'Proprietary' ? 'selected' : '' }}>Proprietary</option>
                                                </select>
                                                @error('license')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="requirements" id="requirements" class="form-control @error('requirements') is-invalid @enderror" 
                                                  rows="3" placeholder="PHP 8.0+, Laravel 10+">{{ old('requirements') }}</textarea>
                                        @error('requirements')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="minimum_php_version" id="minimum_php_version" class="form-control @error('minimum_php_version') is-invalid @enderror" 
                                                       value="{{ old('minimum_php_version', '8.0') }}" placeholder="8.0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="minimum_laravel_version" id="minimum_laravel_version" class="form-control @error('minimum_laravel_version') is-invalid @enderror" 
                                                       value="{{ old('minimum_laravel_version', '10.0') }}" placeholder="10.0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="changelog" id="changelog" class="form-control @error('changelog') is-invalid @enderror" 
                                                  rows="4" placeholder="v1.0.0 - İlk sürüm&#10;v1.1.0 - Yeni özellikler eklendi">{{ old('changelog') }}</textarea>
                                        @error('changelog')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="download_count" id="download_count" class="form-control @error('download_count') is-invalid @enderror" 
                                               value="{{ old('download_count', 0) }}" min="0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="rating" id="rating" class="form-control @error('rating') is-invalid @enderror" 
                                                       value="{{ old('rating', 0.00) }}" min="0" max="5" step="0.01">
                                                @error('rating')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="rating_count" id="rating_count" class="form-control @error('rating_count') is-invalid @enderror" 
                                                       value="{{ old('rating_count', 0) }}" min="0">
                                                @error('rating_count')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fa fa-save"></i> Eklenti Oluştur
                                        </button>
