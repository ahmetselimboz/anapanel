                            ...
                            <div class="author-detail-footer d-flex">
                                <a href="#" title="yazar link">
                                    ...
                                    <div class="w-100 d-flex justify-content-between">
                                        <div>
                                            <small  class="text-white text-opacity-50 text-truncate">Kayıt Tarihi: {{ date('d.m.Y - H:i', strtotime($userprofile->created_at)) }}</small>
                                            <a href="{{ route('userlogout') }}" class="btn btn-success btn-sm">Güvenli Çıkış</a>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                            ...
                                            @foreach($articles as $article)
                                                <li>
                                                    @if($article->publish==0)
                                                        ...
                                                        <span class="btn btn-sm btn-success" style="font-size: 8px;">ONAYLI</span>
                                                    @else
                                                        {{$article->title}}
                                                        <span class="btn btn-sm btn-warning" style="font-size: 8px;">ONAY BEKLİYOR</span>
                                                    @endif
                                                </li>
                                            @endforeach
                                        </ul>
                    ...
                    <div class="col-12">
                        ...
                        <form class="form" action="{{ route('userprofileupdate') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Ad Soyad" name="name" value="{{ $userprofile->name }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Email" value="{{ $userprofile->email }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Telefon" name="phone" value="{{ $userprofile->phone }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="file">
                                                <input type="file" class="form-control w-100" placeholder="Resim" name="avatar">
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="file">
                                                @if($userprofile->avatar!=null)<a class="btn btn-primary btn-sm" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Mevcut Avatarı Göster</a>@endif
                                            </label>
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary"> <i class="ti-save-alt"></i> GÜNCELLE </button>
                            </div>
                        </form>
                    </div>
                </div>
